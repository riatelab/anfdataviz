...
On soite réaliser une carte sur le chômage des ouvriers en Occitanie. Réalisez une 
...
la cartographie thématique proposés par l'UMS RIATE (ref )
...
Ce bloc de code est dédié est à la recolte des données disponibles sur le site d'Eurostat
grâce au package eurostat. La procédure à suivre pour télécharger ses propres données est 
la suivante :
...
5. Filtrez les dimensions du tibble afin de réduire sa structure à deux dimensions
...
7. Quand tous les indicateurs ont été téléchargés et préparés, les joindre à vos géométries de
référence (regions dans notre cas de figure). 
